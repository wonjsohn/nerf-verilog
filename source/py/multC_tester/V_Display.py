...
class CtrlChannel:
    def __init__(self, hostDialog, id, name, type, value = 0.0):
        ...
        self.doubleSpinBox.setGeometry(QtCore.QRect(620, id * 35, 105, 30))
        ...
        self.label.setGeometry(QtCore.QRect(510, id * 35, 105, 30))           
...
class View(QMainWindow, Ui_Dialog):
    ...
    """
    def __init__(self, projectPath,  nerfModel,  fpgaOutput= [], userInput = [],  parent = None):
        """
        Constructor
        """
