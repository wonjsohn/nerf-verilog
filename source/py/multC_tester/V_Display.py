...
class TrigOutChannel:
    def __init__(self, hostDialog, addr, name, type, value = 0.0):
        self.addr = addr
        self.name = name
        self.type = type
        self.value = value
...
#            (filepath, filename) = os.path.split(eachBitFile) 
        ...
        # self.allTriggerOutput = {}
        #
        # self.allTriggerOutput[triggerOutput[1]] = TrigOutChannel(hostDialog=self, addr =triggerOutput[0], name= triggerOutput[1],value=triggerOutput[2], type=triggerOutput[3])
        #
        # print self.allTriggerOutput[triggerOutput[1]].name
