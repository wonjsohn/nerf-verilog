...
from Ui_Display_Each_Channel import Ui_Dialog
...
class ViewChannel:
    def __init__(self, hostDialog, name, id, width = 2, color = Qt.blue, addr = 0x20, type = ""):
        ...
        self.slider.setGeometry(QtCore.QRect(200, 130+ id*100, 29, 100))
...
class View(QMainWindow, Ui_Dialog):
    ...
    """
    def __init__(self, nerfModel,  fpgaOutput= [], userInput = [],  parent = None):
        """
        Constructor
        """
